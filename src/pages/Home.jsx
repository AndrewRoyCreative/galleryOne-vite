  ...
  return (
    ...
    <section className='h-[50vh] sm:h-[70vh] w-full flex flex-col justify-end pl-10 pr-10'>
            <div className='flex-col flex lg:flex-row justify-between pb-3 lg:items-end '>
                <div>
                    <h1 className='text-[76px] sm:text-[92px] text-black leading-none font-semibold'>THIS</h1>
                        <div className='flex flex-row items-center '>
                        <div className='w-[80px] h-[60px] border-[10px] sm:w-[130px] lg:w-full sm:h-[80px] sm:border-[16px] border-primary' />
                            <h1 className='text-[72px] sm:text-[92px] text-black leading-none font-semibold'>IS</h1>
                        </div>
                </div>
                <div className='hidden w-full lg:w-[40%] h-full lg:flex flex-col justify-end text-wrap pb-3 pt-3'>
                    <p className='text-[12px] sm:text-[14px] font-light'>You won't want to miss this one-of-a-kind exhibition of Native American art!
    ...
    {/* HERO IMAGE AND BUTTON */}
        <section>
                ...
                <div className=' w-full h-full flex flex-col justify-end text-wrap pt-3 pr-10 pl-10 lg:hidden mt-5'>
                    <p className='text-[14px] font-light'>You won't want to miss this one-of-a-kind exhibition of Native American art!
                        The show will feature the work of some of the most talented Native American artists,
                        who will be showcasing their unique perspectives and cultural heritage.
                        This is a great opportunity to appreciate the beauty and power of Native American 
                        art and to support the work of these amazing artists. Don't miss out on this incredible event!
    ...
    <section className=' w-full flex flex-col justify-end pl-10 pr-10 mt-20'>
            <div className='flex flex-col lg:flex-row justify-between items-start lg:items-center'>
                <div>
                    <h1 className='text-[72px] sm:text-[92px] text-black leading-none font-semibold'>WHATS</h1>
                        <div className='flex flex-row items-center '>
                        <div className='w-full h-[80px] border-[16px] border-[#EA1B2F]' />
                            <h1 className='text-[72px] sm:text-[92px] text-black leading-none font-semibold'>ON</h1>
                    </div>
                </div>
            ...
            <div className='w-full flex flex-col lg:flex-row justify-center items-center '>
                    ...
                    <div className='hidden lg:inline-block w-[180px] h-[100px] lg:w-full lg:ml-10 lg:h-[180px] border-[20px] border-[#F3B52A]'/>
                            <div className='flex flex-col items-center'>
                                <h1 className='text-center text-[72px] sm:text-[92px] text-black leading-none font-semibold mr-10 ml-10'>A FEW WORDS</h1>
                                    <p className=' text-[14px] w-full mt-5 pl-10 pr-10 text-center md:w-[750px] text-wrap font-light'>Supporting Native American artists
    ...
    <section>
        <div className=' flex flex-col justify-start items-start md:justify-center md:items-center mt-40 lg:mt-64'>
            <h1 className=' w-full lg:w-[70%] text-[72px] sm:text-[92px] text-black leading-none font-semibold pl-10 pr-10 lg:mr-20 lg:ml-20 text-left md:text-center'>BE THE FIRST TO KNOW</h1>
                <p className='w-full md:w-[90%] pl-10 pr-10 lg:w-[70%] text-wrap mt-5 text-[14px] font-light'>Would you like to be the first to hear about new exhibitions? 
