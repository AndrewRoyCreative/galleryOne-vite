        ...
        <div className='w-full flex flex-col md:flex-row md:justify-between md:mt-20'>
            ...
            <div>
                <h5 className='text-[24px] lg:text-[26px] font-semibold mt-5'>MY CULTURE</h5>
                    <p className='w-full mt-5 text-wrap text-[#646464] text-[14px] lg:text-[16px] font-light'
                        >
            ...
            />
                <div className='flex flex-col '>
                    <h5 className='text-[24px] font-semibold mt-5'>THE WAY FORWARD</h5>
                        <p className='mt-5 text-wrap text-[#646464] text-[14px] lg:text-[16px] font-light'
                            >
             ...
             <div className=' hidden w-full lg:flex flex-col pr-10 pl-10'>
                ...
                <div className='w-full flex flex-row justify-between mr-10 ml-10'>
                    ...
                    <div className='hidden w-full lg:flex flex-row justify-start'>
                        <button className='bg-[#F3B52A] w-[200px] text-white p-1 pt-2 pb-2 mt-14 hover:bg-[#DCA52A] transition duration-700 ease-in-out'>READ MORE</button>
                    </div>
                 </div>
</section>
